...
{
    public partial class WDCheckBox : CheckBox
    {
        /*
         * 设置
        ...
        //private Image _checkImg = RenderHelper.GetImageFormResourceStream("ControlExs.QQControls.WDCheckBox.Image.check.png");
        ...
        public WDCheckBox(IContainer container)
        {
            //container.Add(this);
            //InitializeComponent();
        }
        ...
        protected override void OnPaint(PaintEventArgs pevent)
        {
            ...
            switch (_state)
            {
                case QQControlState.Highlight:
                    g.FillEllipse(new SolidBrush(Color.Red), 0, 0, this.Size.Width, this.Size.Height);
                    //g.FillEllipse(new SolidBrush(Color.FromArgb(245, 245, 230)), 0, 0, textRect.Width / 3, textRect.Height / 3);
                    using (Pen borderPen = new Pen(Brushes.Red))
                    {
                        g.DrawEllipse(borderPen, 0, 0, this.Size.Width, this.Size.Height);
                    }
                    break;
                ...
                case QQControlState.Disabled:
                    ...
                    using (Pen borderPen = new Pen(Brushes.WhiteSmoke))
                    {
                        g.DrawEllipse(borderPen, 0, 0, textRect.Width - 1, textRect.Height - 1);
                    }
                    break;
                default:
                    g.FillEllipse(new SolidBrush(Color.FromArgb(245, 245, 230)), 0, 0, this.Size.Width, this.Size.Height);
