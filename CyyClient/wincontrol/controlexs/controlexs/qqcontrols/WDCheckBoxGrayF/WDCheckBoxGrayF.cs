        ...
        protected override void OnPaint(PaintEventArgs pevent)
        {
            ...
            switch (_state)
            {
                case QQControlState.Highlight:
                    ...
                    //g.FillRectangle(new SolidBrush(Color.DimGray), 0, 0, textRect.Width, textRect.Height);
                    using (Pen borderPen = new Pen(Color.FromArgb(96, 96, 96)))
                    {
                ...
                default:
                    ...
                    g.FillRectangle(new SolidBrush(Color.Gainsboro), 0, 0, textRect.Width, textRect.Height);
